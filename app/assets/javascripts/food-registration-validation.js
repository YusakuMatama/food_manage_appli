...
//validation
    .done(function(new_food){
      ...
      if (new_food.calorie.match(/^([1-9]\d*|0)$/) == null){
      ...
      if (new_food.name != "" && new_food.hiragana_name.match(/^[\u3040-\u309F]+$/) != null &&  new_food.calorie.match(/^([1-9]\d*|0)$/) != null && new_food.menu_category_id != null){
